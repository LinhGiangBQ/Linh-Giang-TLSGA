...
<div class="main-header">
    ...
    <p>Tác giả: Ma Thị Linh Giang - Trường Tiểu học Nguyễn Huệ - ĐT: 0352286176</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 -Ma Thị Linh Giang - Trường Tiểu học Nguyễn Huệ - ĐT: 0352286176</div>", unsafe_allow_html=True)
